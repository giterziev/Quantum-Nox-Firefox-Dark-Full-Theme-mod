...
> [!IMPORTANT]
> ### As stated in the **about** section, this is a personal fork of **[Izheil's Quantum Nox](https://github.com/Izheil/Quantum-Nox-Firefox-Dark-Full-Theme)** project to make it work in conjunction with [black7375' Lepton (Firefox-UI-Fix)](https://github.com/black7375/Firefox-UI-Fix).
